...
class Database:
    ...
    def get(self, table, columns='*', where=None, orderBy=None, orderType=None, limit=None):
        result = []
    ...
    def getFirst(self, table, columns, where, orderBy=None, orderType=None, mergeJsonColumn=False):
        result = {}
        ...
        if len(rows) > 0:
            ...
            if mergeJsonColumn:
                jsonColumn = helpers.jsonStringToDictionary(get(result, 'json'))
                result = helpers.mergeDictionaries(result, jsonColumn)
